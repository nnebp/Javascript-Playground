...
var surface = new PIXI.projection.Sprite2d(new PIXI.Texture.fromImage("required/assets/blue.png"));
//var surface = new PIXI.projection.Sprite2d(new PIXI.Texture.WHITE));
